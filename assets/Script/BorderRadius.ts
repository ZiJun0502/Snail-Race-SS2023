...
export default class SpriteRadius extends cc.Component {
  ...
  @property({
    tooltip: CC_DEV && "左上角圆角半径",
    visible() {
      return this.inputMode === InputMode.CocosEditor;
    },
  })
  public get leftTop() {
    return this._leftTop;
  }
  public set leftTop(value: cc.Vec2) {
    this._leftTop = value;
    this.updateProperties();
  }
  ...
  public set rightTop(value: cc.Vec2) {
  ...
  public set rightBottom(value: cc.Vec2) {
  ...
  public set leftBottom(value: cc.Vec2) {
  ...
  @property({
    tooltip: CC_DEV && "配置字符串",
    visible() {
      return this.inputMode === InputMode.Web;
    },
  })
  public get configString() {
    return this._configString;
  }
  public set configString(value: string) {
    this._configString = value;
    this.updateProperties();
  }
  ...
  private cocosEditor(
    ...
    this.material.setProperty(
      "rightBottom",
      this.percentageToPixel(rightBottom)
    );
  ...
  private web(configString: string) {
    ...
    this.material.setProperty(
      "leftTop",
      this.percentageToPixel(radiusPixelArray[0])
    );
    this.material.setProperty(
      "rightTop",
      this.percentageToPixel(radiusPixelArray[1])
    );
    this.material.setProperty(
      "rightBottom",
      this.percentageToPixel(radiusPixelArray[2])
    );
    this.material.setProperty(
      "leftBottom",
      this.percentageToPixel(radiusPixelArray[3])
    );
  }
